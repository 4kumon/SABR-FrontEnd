...
import { AgGridActionsCellComponent } from '../../../../shared/components/ag-grid-actions-cell/ag-grid-actions-cell.component';
...
@Component({
    ...
    standalone: true,
    imports: [CrudToolbarComponent, AgGridModule, NbCardModule, AgGridActionsCellComponent],
})
export class CanaisListComponent implements OnInit {
    private gridApi!: GridApi;

    // Tradução dos textos do AG Grid para Português
    localeText = {
        // Filtros gerais
        filterOoo: 'Filtro...',
        equals: 'Igual a',
    ...
    columnDefs: ColDef[] = [
        ...
        { field: 'dataCriacao', headerName: 'Data de Criação', width: 180 },
        {
            headerName: 'Ações',
            width: 120,
            cellRenderer: AgGridActionsCellComponent,
            cellRendererParams: {
                editCallback: (data: Canal) => this.onEditRow(data),
                deleteCallback: (data: Canal) => this.onDeleteRow(data),
            },
        },
    ];
