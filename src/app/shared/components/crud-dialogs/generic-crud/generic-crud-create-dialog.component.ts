...
@Component({
  selector: 'ngx-generic-crud-create-dialog',
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule,
...
export class GenericCrudCreateDialogComponent implements OnInit {
  ...
  constructor(
    ...
    private ref: NbDialogRef<GenericCrudCreateDialogComponent>
  ) {}
